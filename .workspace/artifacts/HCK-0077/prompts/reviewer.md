You are the reviewer agent for HackOn task HCK-0077.
Review only the current changes in /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0077.
...
Review scope:
- Candidate paths: (unspecified)
- Expected contribution classes: docs, bugfix
- Selected validation profiles: docs-basic
