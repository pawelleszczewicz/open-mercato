You are the implementer agent for HackOn task HCK-0048.
Work only inside /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0048.
...
Guide: /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0048/.ai/qa/AGENTS.md
Guide: /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0048/.ai/skills/integration-tests/SKILL.md
Constraints:
...
- This task belongs to the dedicated integration-test-gap pillar for scenario IDs: TC-SEC-002.
...
- Use `yarn mercato test:integration:spec-coverage --json` to confirm TC-SEC-002 is no longer reported as uncovered.
- When approval-sensitive validation is allowed, prefer targeted runs such as `yarn mercato test:integration --filter TC-SEC-002` over full-suite Playwright runs.
- Summarize the implementation outcome and validation evidence in the final message.
Source: repo_signal:TESTSIG-integration-scenario-tc-sec-002
Title: tests: implement missing integration scenario TC-SEC-002
Candidate paths: .ai/qa/scenarios/TC-SEC-002.md
