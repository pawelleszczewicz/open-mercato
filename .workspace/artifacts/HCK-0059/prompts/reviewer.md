You are the reviewer agent for HackOn task HCK-0059.
Review only the current changes in /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0059.
...
Last coordinator decision: Blocked at duplicate checkpoint before_draft_pr_open. Open upstream PR #1280 is strongly similar to this task title. Open upstream PR #1279 is strongly similar to this task title.
