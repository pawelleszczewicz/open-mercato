You are the implementer agent for HackOn task HCK-0059.
Work only inside /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0059.
...
Guide: /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0059/.ai/qa/AGENTS.md
Guide: /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0059/.ai/skills/integration-tests/SKILL.md
Constraints:
...
- This task belongs to the dedicated integration-test-gap pillar for scenario IDs: TC-DOCKER-003.
...
- Use `yarn mercato test:integration:spec-coverage --json` to confirm TC-DOCKER-003 is no longer reported as uncovered.
- When approval-sensitive validation is allowed, prefer targeted runs such as `yarn mercato test:integration --filter TC-DOCKER-003` over full-suite Playwright runs.
...
Candidate paths: .ai/qa/scenarios/TC-DOCKER-003-exec-initialize-reinstall.md
