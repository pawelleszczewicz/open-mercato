You are the reviewer agent for HackOn task HCK-0085.
Review only the current changes in /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0085.
...
- Selected validation profiles: create-app-package-checks
