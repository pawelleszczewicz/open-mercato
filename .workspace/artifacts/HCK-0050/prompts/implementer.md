You are the implementer agent for HackOn task HCK-0050.
Work only inside /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0050.
...
Guide: /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0050/.ai/qa/AGENTS.md
Guide: /home/hacker/repo/open-mercato/.workspace/worktrees/open-mercato/HCK-0050/.ai/skills/integration-tests/SKILL.md
Constraints:
...
- This task belongs to the dedicated integration-test-gap pillar for scenario IDs: TC-SEC-004.
...
- Use `yarn mercato test:integration:spec-coverage --json` to confirm TC-SEC-004 is no longer reported as uncovered.
- When approval-sensitive validation is allowed, prefer targeted runs such as `yarn mercato test:integration --filter TC-SEC-004` over full-suite Playwright runs.
- Summarize the implementation outcome and validation evidence in the final message.
Source: repo_signal:TESTSIG-integration-scenario-tc-sec-004
Title: tests: implement missing integration scenario TC-SEC-004
Candidate paths: .ai/qa/scenarios/TC-SEC-004.md
Expected contribution classes: tests
Duplicate risk: likely_duplicate