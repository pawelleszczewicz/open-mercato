...
const binPoints = await glob('bin/**/*.ts', {
  cwd: __dirname,
  ignore: [],
  absolute: true,
})

const allEntryPoints = [...entryPoints, ...binPoints]
...
console.log(`Found ${allEntryPoints.length} entry points`)
...
console.log('hackonctl built successfully')
